 ...
 * @type {string}
 */
const API_ROOT = "http://localhost:8081/";//"http://transportec-api.azurewebsites.net";
...
function recorrerRespuesta(respuesta,texto,identificador) {
    ...
    for (i=0;i<largo;i++){
        var diccionario={};
        diccionario.model=respuesta[i][texto];
        diccionario.num=cont;
        diccionario.id=respuesta[i][identificador];
