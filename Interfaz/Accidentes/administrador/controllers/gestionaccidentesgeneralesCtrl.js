...
angular.module('adminModule').controller('gestionaccidentesgeneralesCtrl', function($scope,$location,$http,peticiones) {
    ...
    $scope.eliminar = function (registro) {
        ...
        peticiones.eliminarD("eliminarAccidenteGeneral",$scope.accidentesGeneralesAux[registro]["idaccidente"])
            .then(function (response) {
                console.log(response);
                $scope.accidentesGeneralesAux.splice(registro,1);
    ...
    $scope.seleccionarDistritos=function () {
        ...
        console.log(">>>>>>"+$scope.cantones[indice].id);
    ...
    if (window.location.href.indexOf('insertarAccidenteGeneral')!=-1){
    ...
    if (window.location.href.indexOf('mostrarAccidentesGenerales')!=-1) {
